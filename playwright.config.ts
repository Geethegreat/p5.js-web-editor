...
export default defineConfig({
  ...
  /**
   * The app is started automatically, on dedicated e2e ports (9000/9002,
   * from .env.e2e), so reuseExistingServer can never latch onto a regular
   * dev server on 8000 (which would point at the real dev database).
